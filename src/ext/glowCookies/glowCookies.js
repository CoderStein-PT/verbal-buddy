...
class GlowCookies {
  ...
  //     'href',
  //     `https://cdn.jsdelivr.net/gh/manucaralmo/GlowCookies@3.1.3/src/glowCookies.min.css`
  //   )
  ...
  activateTracking() {
    ...
    if (this.tracking.FacebookPixelCode) {
      ...
      FacebookPixel.setAttribute(
        'src',
        `https://www.facebook.com/tr?id=${this.tracking.FacebookPixelCode}&ev=PageView&noscript=1`
      )
  ...
  start(languaje, obj) {
    ...
    this.config = {
      ...
      managePosition: obj.managePosition || 'left',
    ...
    this.banner = {
      ...
      heading:
        obj.bannerHeading !== 'none'
          ? obj.bannerHeading || lang.bannerHeading
          : '',
      acceptBtn: {
  ...
  init() {
    this.arrLang = {
      af: {
        ...
        bannerDescription:
          'Ons gebruik ons eie koekies en die van derdepartye, om inhoud te verpersoonlik en om webverkeer te ontleed.',
      ...
      bg: {
        ...
        bannerDescription:
          'Използваме наши и бисквитки на трети страни, за да запазим Вашите предпочитания и да събираме аналитични данни.',
      ...
      de: {
        ...
        bannerDescription:
          'Wir nutzen Cookies (auch von Drittanbietern), um Inhalte zu personalisieren und Surfverhalten zu analysieren.',
      ...
      sv: {
        ...
        bannerDescription:
          'Vi använder våra egna och tredjepartscookies för att personalisera innehåll och till statistik.',
      ...
      no: {
        ...
        bannerDescription:
          'Vi benytter våre egne og tredjepartscookies for å personalisere innehold og til statistikk.',
      ...
      da: {
        ...
        bannerDescription:
          'Vi bruger vores egne og tredjepartscookies til at tilpasse indhold og måle statistik.',
      ...
      fr: {
        ...
        bannerDescription:
          'Nous utilisons nos propres cookies et ceux de tiers pour adapter le contenu et analyser le trafic web.',
      ...
      nl: {
        ...
        bannerDescription:
          'We gebruiken onze en third-party cookies om content te personaliseren en web traffic te analyseren.',
      ...
      oc: {
        ...
        bannerDescription:
          'Utilizam nòstres pròpris cookies e de cookies tèrces per adaptar lo contengut e analisar lo trafic web.',
      ...
      sk: {
        ...
        bannerDescription:
          'Na prispôsobenie obsahu a analýzu webovej stránky používame vlastné cookies a cookies tretích strán.',
      ...
      th: {
        ...
        bannerDescription:
          'พวกเราใช้คุกกี้บุคคลที่สาม เพื่อปรับแต่งเนื้อหาและวิเคราะห์การเข้าชมเว็บ',
      ...
      uk: {
        ...
        bannerDescription:
          'Ми використовуємо власні та сторонні cookie для персоналізації досвіду користування та аналізу веб-трафіку.',
      ...
      ja: {
        ...
        bannerDescription:
          '私たちは、コンテンツのパーソナライズやトラフィックの分析のために、独自およびサードパーティー製 Cookies を使用しています。',
      ...
      zh_TW: {
        ...
        bannerDescription:
          '我們使用了自己和第三方的 cookies 來個人化您的內容和分析網頁的流量。',
      ...
      zh: {
        ...
        bannerDescription:
          '我们使用了自己和第三方的 cookies 来个性化您的内容和分析网页的流量。',
